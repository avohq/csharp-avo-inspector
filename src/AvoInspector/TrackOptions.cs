namespace Avo.Inspector
{
    ...
    /// <remarks>
    /// <para>
    /// Not part of <c>avohq/spec-first-inspector-server-sdk</c> v1.0.0 - this is an Avo-contract
    /// extension (AVO-3516 / AVO-3543), documented the same way the <c>sessionId</c> divergence is
    /// documented on <see cref="Internal.WireEvent"/>.
    /// </para>
    /// <para>
    ...
    public sealed class TrackOptions
    {
        ...
        /// reaches the Inspector dashboard. See the README "Gateways" section and
        /// <c>CHANGELOG.md</c>'s <c>1.1.0</c> entry for the same warning.
        /// </remarks>
        public string? OriginHint { get; set; }

        /// <summary>
        /// App version of the source that produced this event, for this event only.
        /// <para>
